        ...
        <div className="flex mt-16 md:flex-row flex-col justify-between items-center gap-5">
            ...
            <div className="flex items-center md:gap-3 gap-6">
                {socialMedia.map((profile) => (
                    ...
                    <div  key={profile.id} className="w-10 h-10 cursor-pointer flex justify-center items-center backdrop-filter backdrop-blur-lg saturate-180 bg-opacity-75 dark:bg-black-300 bg-purple rounded-lg border dark:border-black-300 border-slate-400 hover:bg-pink-300 transition-all">
